...
app.config['MAIL_USERNAME'] = 'helpscai@gmail.com'  # Replace with your email address
app.config['MAIL_PASSWORD'] = 'qihtnzfigqpjbjfm'  # Replace with your app password
app.config['MAIL_DEFAULT_SENDER'] = 'helpscai@gmail.com'  # Replace with your email address
